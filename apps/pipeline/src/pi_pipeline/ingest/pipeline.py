...
from pi_core.enrich.reindex import CACHE_SUFFIX
from pi_core.enrich.resolutions import SOLUCION_META_MAX, enrich_resolution
from pi_core.schemas import Ticket
from pi_core.services.embeddings import EmbeddingService
from pi_core.storage.vector_db.client import get_tickets_collection
from pi_pipeline.ingest.normalize import (
    assign_split,
    extract_sample,
    load_glpi_excel,
    parse_date,
