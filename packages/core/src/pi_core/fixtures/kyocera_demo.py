...
from pi_core.storage.kedb_store.store import new_articulo_id
...
def reset_demo_state(
    ...
    *,
    ...
    """
    from pi_core.config import get_settings
    from pi_core.storage.kedb_store.markdown import docs_dir
    ...
    if clear_chroma and removed_ids:
        try:
            from pi_core.storage.vector_db.client import get_kedb_collection
